...
!(function ($) {
    ...
    */
    ...
    window.ParsleyConfig.i18n.en = $.extend(window.ParsleyConfig.i18n.en || {}, {
        defaultMessage: Languages.defaultMessage,
        type: {
            email: Languages.email,
            url: Languages.url,
            number: Languages.number,
            integer: Languages.integer,
            digits: Languages.digits,
            alphanum: Languages.alphanum
        },
        notblank: Languages.notblank,
        required: Languages.required,
        pattern: Languages.pattern,
        min: Languages.min,
        max: Languages.max,
        range: Languages.range,
        minlength: Languages.minlength,
        maxlength: Languages.maxlength,
        length: Languages.length,
        mincheck: Languages.mincheck,
        maxcheck: Languages.maxcheck,
        check: Languages.check,
        equalto: Languages.equalto
    });
