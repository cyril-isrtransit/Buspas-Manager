...
b){void 0!==b.domElement&&b.domElement.parentNode&&b.positionElement()})});f.ext.buttons.copyFlash=g.extend({},i,{className:"buttons-copy buttons-flash",text:function(a){return a.i18n("buttons.copy",Languages.Copy)},action:function(a,b,d,c){c._fromFlash&&(a=c._flash,c=o(b,c),a.setAction("copy"),k(a,c.str),b.buttons.info(b.i18n("buttons.copyTitle","Copie dans le presse papier"),b.i18n("buttons.copyInfo",{_:"Copie de %d lignes dans le presse papier",1:"Copie d'une ligne dans le presse papier"},c.rows),3E3))},fieldSeparator:"\t",fieldBoundary:""});
