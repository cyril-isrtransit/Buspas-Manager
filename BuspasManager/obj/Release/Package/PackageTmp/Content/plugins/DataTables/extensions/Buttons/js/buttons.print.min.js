(function(f,g){var b=document.createElement("a"),i=function(c,a){"link"===a.nodeName.toLowerCase()&&(b.href=a.href,a.href=b.protocol+"//"+b.host+b.pathname+b.search)};g.ext.buttons.print={className:"buttons-print",text:function(c){return c.i18n("buttons.print",Languages.Print)},action:function(c,a,b,d){c=a.buttons.exportData(d.exportOptions);b=function(a,c){for(var b="<tr>",d=0,e=a.length;d<e;d++)b+="<"+c+">"+a[d]+"</"+c+">";return b+"</tr>"};a='<table class="'+a.table().node().className+'">';d.header&&(a+=
